...
export default function SocialSection() {
  return (
    <section className="section social-section" id="follow">
      <div className="wrap">
        ...
        <div className="social-grid">
            ...
            <div className="social-card-top">
              <div className="social-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#fff">
                  <path d="M16.5 3c.4 2 1.9 3.5 4 3.8v3c-1.5 0-2.9-.4-4-1.2v6.4c0 3.3-2.7 6-6 6s-6-2.7-6-6 2.7-6 6-6c.4 0 .8 0 1.2.1v3.1c-.4-.1-.8-.2-1.2-.2-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3V3h3z" />
                </svg>
              </div>
          ...
          >
            <div className="social-card-top">
              <div className="social-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#fff">
                  <path d="M13.5 21v-7.5h2.5l.5-3H13.5V8.5c0-.9.25-1.5 1.5-1.5h1.5V4.35C16.25 4.25 15.19 4 14 4c-2.5 0-4 1.5-4 4.5V10.5H7.5v3H10V21h3.5z" />
                </svg>
              </div>
              <span className="social-follow-btn">Follow</span>
            </div>
